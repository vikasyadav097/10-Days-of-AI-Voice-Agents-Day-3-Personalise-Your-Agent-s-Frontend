...
"Hi! I'm LearnMate, your Learning and Literacy assistant.
I can help you with English, reading, vocabulary, grammar,
pronunciation, maths, science, computer science, and more.
...
async def my_agent(ctx: JobContext):
    ...
    session = AgentSession(
        ...
        # Generate responses while waiting for the end of turn
